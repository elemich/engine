...
interface ID2D1BitmapBrush : public ID2D1Brush {
    ...
    STDMETHOD_(void, GetExtendModeX)(D2D1_EXTEND_MODE&) const PURE;
    STDMETHOD_(void, GetExtendModeY)(D2D1_EXTEND_MODE&) const PURE;
    STDMETHOD_(void, GetInterpolationMode)(D2D1_BITMAP_INTERPOLATION_MODE&) const PURE;
...
interface ID2D1RenderTarget : public ID2D1Resource {
    ...
    STDMETHOD_(void, GetAntialiasMode)(D2D1_ANTIALIAS_MODE&) const PURE;
    STDMETHOD_(void, SetTextAntialiasMode)(D2D1_TEXT_ANTIALIAS_MODE textAntialiasMode) PURE;
    STDMETHOD_(void, GetTextAntialiasMode)(D2D1_TEXT_ANTIALIAS_MODE&) const PURE;
...
interface ID2D1GeometryGroup : public ID2D1Geometry {
    STDMETHOD_(void, GetFillMode)(D2D1_FILL_MODE&) const PURE;
...
interface ID2D1GradientStopCollection : public ID2D1Resource {
    ...
    STDMETHOD_(void, GetColorInterpolationGamma)(D2D1_GAMMA&) const PURE;
    STDMETHOD_(void, GetExtendMode)(D2D1_EXTEND_MODE&) const PURE;
};
...
interface ID2D1HwndRenderTarget : public ID2D1RenderTarget {
    STDMETHOD_(void, CheckWindowState)(D2D1_WINDOW_STATE&) PURE;
...
interface ID2D1LinearGradientBrush : public ID2D1Brush {
    ...
    STDMETHOD_(void, GetStartPoint)(D2D1_POINT_2F&) const PURE;
    STDMETHOD_(void, GetEndPoint)(D2D1_POINT_2F&) const PURE;
...
interface ID2D1RadialGradientBrush : public ID2D1Brush {
    ...
    STDMETHOD_(void, GetCenter)(D2D1_POINT_2F&) const PURE;
    STDMETHOD_(void, GetGradientOriginOffset)(D2D1_POINT_2F&) const PURE;
...
interface ID2D1SolidColorBrush : public ID2D1Brush {
    ...
    STDMETHOD_(void, GetColor)(D2D1_COLOR_F&) const PURE;
...
interface ID2D1StrokeStyle : public ID2D1Resource {
    STDMETHOD_(void, GetStartCap)(D2D1_CAP_STYLE&) const PURE;
    STDMETHOD_(void, GetEndCap)(D2D1_CAP_STYLE&) const PURE;
    STDMETHOD_(void, GetDashCap)(D2D1_CAP_STYLE&) const PURE;
    STDMETHOD_(FLOAT, GetMiterLimit)(void) const PURE;
    STDMETHOD_(void, GetLineJoin)(D2D1_LINE_JOIN&) const PURE;
    STDMETHOD_(FLOAT, GetDashOffset)(void) const PURE;
    STDMETHOD_(void, GetDashStyle)(D2D1_DASH_STYLE) const PURE;
