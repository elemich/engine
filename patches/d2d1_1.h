...
interface ID2D1Properties : public IUnknown
{
    ...
    STDMETHOD_(void, GetType)(UINT32 index,D2D1_PROPERTY_TYPE&) CONST PURE;
...
{
    STDMETHOD_(void, GetStrokeTransformType)(D2D1_STROKE_TRANSFORM_TYPE&) CONST PURE;
};
...
interface ID2D1Bitmap1 : public ID2D1Bitmap
{
    ...
    STDMETHOD_(void, GetOptions)(D2D1_BITMAP_OPTIONS&) CONST PURE;
...
interface ID2D1ImageBrush : public ID2D1Brush
{
    ...
    STDMETHOD_(void, GetInterpolationMode)(D2D1_INTERPOLATION_MODE&) CONST PURE;
...
interface ID2D1BitmapBrush1 : public ID2D1BitmapBrush
{
    ...
    STDMETHOD_(void, GetInterpolationMode1)(D2D1_INTERPOLATION_MODE&) CONST PURE;
};
...
interface ID2D1GradientStopCollection1 : public ID2D1GradientStopCollection
{
    ...
    STDMETHOD_(void, GetPreInterpolationSpace)(D2D1_COLOR_SPACE&) CONST PURE;
    STDMETHOD_(void, GetPostInterpolationSpace)(D2D1_COLOR_SPACE&) CONST PURE;
    STDMETHOD_(void, GetBufferPrecision)(D2D1_BUFFER_PRECISION&) CONST PURE;
    STDMETHOD_(void, GetColorInterpolationMode)(D2D1_COLOR_INTERPOLATION_MODE&) CONST PURE;
};
...
{
    STDMETHOD_(void, GetColorSpace)(D2D1_COLOR_SPACE&) CONST PURE;
...
interface ID2D1DeviceContext : public ID2D1RenderTarget
{
    ...
    STDMETHOD_(void, GetPrimitiveBlend)(D2D1_PRIMITIVE_BLEND&) CONST PURE;
    STDMETHOD_(void, SetUnitMode)(D2D1_UNIT_MODE unitMode) PURE;
    STDMETHOD_(void, GetUnitMode)(D2D1_UNIT_MODE&) CONST PURE;
