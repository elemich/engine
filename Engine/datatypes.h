...
template <class T,int size> struct TMathVectorInterface
{
	T v[size];
};
...
struct vec2 : TMathVectorInterface<float,2>
{
	float &x,&y;
...
struct vec3 : TMathVectorInterface<float,3>
{
	float &x,&y,&z;
...
struct vec4 : TMathVectorInterface<float,4>
{
	float &x,&y,&z,&w;
...
struct mat2 : TMathVectorInterface<float,4>
{
...
struct mat3 : TMathVectorInterface<float,9>
{
...
struct mat4 : TMathVectorInterface<float,16>
{
