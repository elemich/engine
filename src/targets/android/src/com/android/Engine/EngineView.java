...
class EngineView extends GLSurfaceView {
	...
	public String GetEventActionString(int code)
	{
		switch(code)
		{
	...
	public boolean onTouchEvent(MotionEvent event) 
	{
		...
		//Log.i(TAG,"action: " + GetEventActionString(event.getActionMasked()) + " , pointerID: " + event.getPointerId(0) + " , pointerIdx: " + pointerIndex + " , pos: " + x + "," + y);

		SetTouchEvent(event.getActionMasked(),event.getPointerId(0),pointerIndex,x,y);

		/*
		touchEvent[0]=event.getActionMasked();
		touchEvent[1]=event.getPointerId(0);
		touchEvent[2]=pointerIndex;
		touchEvent[3]=x;
		touchEvent[4]=y;
		*/
